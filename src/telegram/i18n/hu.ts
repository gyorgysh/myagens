...
export const hu: Record<keyof typeof en, string> = {
  ...
  bot_fallback_engaged: "⚠️ Az elsődleges modell nem elérhető, újrapróbálom ezen keresztül: {name}…",
  ...
  reload_explain:
    "🆘 <b>/reload — mentőút</b>\nEz a következőket teszi:\n1. Eldobja a helyi, nem commitolt módosításokat a verziókövetett fájlokban (mint a <code>git reset --hard</code>)\n2. Érintetlenül hagyja a <code>data/</code>, <code>.env</code>, <code>work.md</code> és minden más gitignore-olt fájlt\n3. Lehúzza a legújabb commitot a GitHubról\n4. Újratelepíti a függőségeket és újraépít\n5. Újraindítja a panel + bot szolgáltatást\n\nEz a chat autonómia módjától függetlenül működik — sosem megy át a modellen. Jóváhagyás a folytatáshoz.",
  reload_confirm_btn: "✅ Igen, reload",
  reload_cancel_btn: "✋ Mégse",
  reload_cancelled: "Megszakítva — semmi sem változott.",
  reload_running: "⏳ Egy frissítés/reload már fut.",
  reload_starting: "🆘 <b>Reload folyamatban…</b>",
  reload_starting_service: "A bot újraindul, amikor a build elkészül.",
  reload_starting_manual: "Az új kód betöltéséhez indítsd újra a futtatást.",
  reload_started_toast: "Reload elindítva…",
