...
*21 live connectors · 30 languages · AES-256 encrypted vault · full audit log · works fully offline*
...
src/
  ...
  core/               telegraf-free layer shared by all agents and the panel
    ...
    connectors.ts     external-connector catalog (Notion, GCal, Gmail, Drive, Apple Cal/Mail, Slack, GitHub, Unreal, Unity, PostgreSQL, SQLite, Jira, Linear, Bluesky, Mastodon, Discord, Reddit, X, YouTube, Facebook Pages) + read/write scope + social multi-account CRUD
