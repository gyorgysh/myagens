...
export const CONNECTORS: ConnectorDef[] = [
  ...
  { id: "youtube", name: "YouTube", description: "Read channel stats, list your uploads and their comments; upload videos, update titles/descriptions, and reply to comments. Supports multiple channels.", credential: "Google OAuth access token (youtube.force-ssl scope)", status: "live", hasWrite: true, category: "social", multiAccount: true },
  { id: "facebook", name: "Facebook Pages", description: "Read a Page's info and feed with engagement counts; publish posts, comment, and delete posts on Pages you admin (personal profiles are not supported by the API). Supports multiple Pages.", credential: "Page access token (long-lived, from your own Meta developer app)", status: "live", hasWrite: true, category: "social", multiAccount: true },
];
